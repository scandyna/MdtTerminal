...
TEST_CASE("GetAttributes")
{
  ...
  TestPortInfo ttyUSB0 = TestPortInfo::fromPortNameAndSystemLocation("ttyUSB0", "/dev/ttyUSB0");
  ttyUSB0.setDescription("Some description");
  ttyUSB0.setManufacturer("Some manufacturer");
  ttyUSB0.setSerialNumber("28546");
  ttyUSB0.setVendorIdentifier(0x1234);
  ttyUSB0.setProductIdentifier(0x5678);
...
TEST_CASE("removeAvailablePort")
{
  ...
  TestPortInfo ttyUSB0 = TestPortInfo::fromPortNameAndSystemLocation("ttyUSB0", "/dev/ttyUSB0");
  TestPortInfo ttyS0 = TestPortInfo::fromPortNameAndSystemLocation("ttyS0", "/dev/ttyS0");
